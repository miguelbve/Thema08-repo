...
In dit onderzoek worden de parameters R en m geprogrammeerd, omdat deze variabel per tijdseenheid zijn. Op internet is de volgende internet bron gebruikt die uitlegt waar de formule dR/dt = -rR + m vandaan komt; \@ref(fig:formule_uitleg_bron)

```{r formule_uitleg_bron}
knitr::include_graphics("model_reference.png")
```

https://d2vlcm61l7u1fs.cloudfront.net/media%2Fe7e%2Fe7e23282-c3fd-4367-8a63-a13364e0c120%2FphpSLUnLT.png (netjes in de bibliotheek bibtex).
...
Hierbij de code die de resultaten oplevert voor het model:
...
Het figuur hierboven beeld 3 scenario's uit die kunnen gebeuren bij mRNA. Een stable-state, dus waarbij
...
veel andere doeleinden zoals data van een bevolingsgroep of bijvoorbeeld eiwit data ook gebruikt kunnen worden.
