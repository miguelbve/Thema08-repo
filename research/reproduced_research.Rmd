...
parameters <- c(CLuint = 4, CLmHT =  0, KPmid = 7.4, Qpf = 0.01, KPendo = 14.0, KPpf = 2.6, Car = 100 / 0.0257, fup = 0.05, KPepi = 3, fupf = 0.05, P = 0.78, BP = 1.04, Qhe = 200, CLuint2C8 = 0.072, CLuint2C9 = 0.079, CLuint2J2 = 0, Vmax_pmol = 4, CYP = 10, Wli = 20.9, MW = 55.825, MPPGL = 45)
...
# Set initial values
state <- c(Cepi = 10, Cmid = 10, Cendo = 10, Cpf = 10)
t <- seq(0, 30, by = 0.1)
...
plot(out$time, out$Cmid, type = "l", lwd = 3)
plot(out$time, out$Cendo, type = "l", lwd = 3)
plot(out$time, out$Cepi, type = "l", lwd = 3)
plot(out$time, out$Cpf, type = "l", lwd = 3)
