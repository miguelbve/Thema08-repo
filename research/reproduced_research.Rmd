...
parameters_2 <- c(CLuint = 10, KPmid = 7.4, Qpf = 0.01, KPendo = 14.0, KPpf = 2.6, Car = 2.5 / 0.0257, fup = 0.05, KPepi = 3, fupf = 0.05, P = 0.78, BP = 1.04, Qhe = 1, CLuint2C8 = 0.072, CLuint2C9 = 0.079, CLuint2J2 = 0, Vmax_pmol = 4, CYP = 10, Wli = 20.9, MW = 55.825, MPPGL = 45)
...
PBPK_func <- function(t, y, parms) {
    with(as.list(c(y, parms)),{
      ...
      dAepi_dt <- 0.2 * (Car - (Cepi / 3) * BP) - 1/3 * CLmHT * Cepi * 0.05 - 0.78 * (Cepi - 0.05 * 3)
...
# Set initial values
state <- c(Cepi = 0.1, Cmid = 0.1, Cendo = 0.1, Cpf = 0.1)
t <- seq(0, 100, by = 1)
...
out_2 <- deSolve::ode(times = t_2, y=out[length(t),2:5], parms = parameters_2,
                    func = PBPK_func, method = "lsoda")
