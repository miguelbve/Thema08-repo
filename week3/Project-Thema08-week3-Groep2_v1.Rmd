...
out1 <- ode(y=state,times=t_1, func=Glucocorticoid_func, parms=parameters)

# Maak D = 0
parameters[1] <- 0

out2 <- ode(y=out1[length(t_1),2:5], times=t_2, func=Glucocorticoid_func, parms=parameters) 
