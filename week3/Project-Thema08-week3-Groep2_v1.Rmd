...
ObservationTimes<-seq(0, 48, by=1)
ObservationTimes2 <- seq(0, 72, by=1)
...
out1 <- ode(y=state,times=ObservationTimes, func=Glucocorticoid_func, parms=parameters)

# Maak D = 0
parameters[1] <- 0

out2 <- ode(y=out1[length(ObservationTimes),2:5], times=ObservationTimes2,   						func=Glucocorticoid_func, parms=parameters) 
