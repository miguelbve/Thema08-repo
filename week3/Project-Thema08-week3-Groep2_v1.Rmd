...
lines(medians_01$time, medians_01$Free_receptor, type = "l", col= "red")
```
Het figuur linksboven en linksonder (de experimentele data) komen wel overeen met elkaar, ze lijken dus een onderliggende relatie te hebben. Ze komen alleen niet volledig overeen, omdat ...
